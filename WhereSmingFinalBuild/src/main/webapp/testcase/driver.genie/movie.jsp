		...
		<div id="dvMeta">
			...
			<table border="0">
				...
				<tr><td><span class="b">
					...
					<!-- 영화시간크롤링 -->
					<span class="b"> · 2시간 9분 · 평점 9.5점 </span>
					</td>
				</tr>
					...
					<c:choose>
						<c:when test="${empty loginMember }">
							<td>ㅤ<a href="login.jsp"><i
									class="fa-solid fa-heart fa-2x" style="color: rgb(253, 85, 85)"></i></a>ㅤ찜하기
							</td>
						</c:when>
						<c:otherwise>
							<td>ㅤ<a href="mypage.jsp"><i
									class="fa-solid fa-heart fa-2x" style="color: rgb(253, 85, 85)"></i></a>ㅤ찜하기
							</td>
						</c:otherwise>
					</c:choose>
		...
		<section class="mb-5">
			<div class="card-body">
				...
				<form class="mb-4" sytle="width: 1200px;" action="../../AddReview"
					method="get">
					<!-- 리뷰 제출용 비행기  -->
					<div id="paper" class="fa-solid fa-paper-plane fa-2x"
