...
<!-- 	<script>
	...
	<section class="services" style="top: 850px;">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<a class="inline">ㅤToday Movie Pick!</a>
					<div class="slider">
							<%
							...
							String[] grd = {"kid", "ani", "ac",	"co", "ro", "th", "ho", "sf", "fa", "cri", "dra", "doc", "mus"};
							Random rd = new Random();
							int num = rd.nextInt(grd.length);
							String random = grd[num];
							
							list0 = dao.selectGenre(random);
							...
							<div class="portfolio-item col-md-7 sizing">
								<div class="portfolio-bg">
									<div class="portfolio">
										<a href="picks.jsp" target="_blank">
